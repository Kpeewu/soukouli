        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Choisissez le cours de la nouvelle interrogation
                </h1>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-vcenter">
                        <thead>
                            <tr>
                                <th>Nom du cours</th>
                                <th class="text-center" style="width: 100px;">Ajouter une interrogation</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($cours)
                                                ...
                                                <div class="dropdown-menu font-size-sm"
                                                    ...
                                                    @foreach ($trimestres as $trimestre)
                                                        <a class="dropdown-item"
                                                            href="{{ route('evaluation.create.interrogation', ['classe' => $classe, 'cours' => $cour, 'trimestre' => $trimestre]) }}">{{ substr($trimestre->intitule, 0, 11) }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </td>
                            ...
                            @else
                                <tr>
                                    <td colspan="2">Pas de cours disponibles pour la classe</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
