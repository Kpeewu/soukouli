        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Choisissez la matière du devoir ou de la composition
                </h1>
                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 100px;">Voir les devoirs et compositions</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($matieres)
                                                ...
                                                <div class="dropdown-menu font-size-sm"
                                                    ...
                                                    @foreach ($promotion->trimestres as $trimestre)
                                                        <a class="dropdown-item"
                                                            href="{{ route('evaluation.index', ['promotion' => $promotion, 'matiere' => $matiere, 'trimestre' => $trimestre]) }}">{{ substr($trimestre->intitule, 0, 11) }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </td>
